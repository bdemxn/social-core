...
export const metadata: Metadata = {
	...
	description: "Connect, share and discover in a clean, distraction-free environment.",
	keywords: ["social network", "minimalist social media", "connect", "discover", "Social Core"],
